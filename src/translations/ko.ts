export const ko = {
  ...
  'settings.recommendation.notificationTitle': '추천 알림',
  'settings.recommendation.overlapRangeToast': '기존의 제외할 시간대와  겹쳐요!',
  'settings.recommendation.pushCaption': '추천 가능한 일정이 생기면 알림을 보내드려요',
  'settings.recommendation.pushLabel': '추천 알림 앱 푸시',
